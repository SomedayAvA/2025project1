...
void TraCIDemo11pMessage::copy(const TraCIDemo11pMessage& other)
{
    ...
    this->s1Ciphertext = other.s1Ciphertext;
    this->d1Ciphertext = other.d1Ciphertext;
    this->publicKeyStr = other.publicKeyStr;
    this->SValues = other.SValues;
    this->DValues = other.DValues;
}
...
void TraCIDemo11pMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimUnpacking(b,this->s1Ciphertext);
    doParsimUnpacking(b,this->d1Ciphertext);
    doParsimUnpacking(b,this->publicKeyStr);
    doParsimUnpacking(b,this->SValues);
    doParsimUnpacking(b,this->DValues);
}
...
const char * TraCIDemo11pMessage::getS1Ciphertext() const
{
    return this->s1Ciphertext.c_str();
}

void TraCIDemo11pMessage::setS1Ciphertext(const char * demoData)
{
    this->s1Ciphertext = demoData;
}

const char * TraCIDemo11pMessage::getD1Ciphertext() const
{
    return this->d1Ciphertext.c_str();
}

void TraCIDemo11pMessage::setD1Ciphertext(const char * demoData)
{
    this->d1Ciphertext = demoData;
}

const char * TraCIDemo11pMessage::getPublicKeyStr() const
{
    return this->publicKeyStr.c_str();
}

void TraCIDemo11pMessage::setPublicKeyStr(const char * demoData)
{
    this->publicKeyStr = demoData;
}

const char * TraCIDemo11pMessage::getSValues() const
{
    return this->SValues.c_str();
}

void TraCIDemo11pMessage::setSValues(const char * demoData)
{
    this->SValues = demoData;
}const char * TraCIDemo11pMessage::getDValues() const
{
    return this->DValues.c_str();
}

void TraCIDemo11pMessage::setDValues(const char * demoData)
{
    this->DValues = demoData;
}
